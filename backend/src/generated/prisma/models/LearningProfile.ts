...
// @ts-nocheck 
/*
 * This file exports the `LearningProfile` model and its related types.
 *
...
export type GetLearningProfileAggregateType<T extends LearningProfileAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateLearningProfile[P]>
    : Prisma.GetScalarType<T[P], AggregateLearningProfile[P]>
}
...
export type GetLearningProfileGroupByPayload<T extends LearningProfileGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<LearningProfileGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof LearningProfileGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], LearningProfileGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], LearningProfileGroupByOutputType[P]>
      }
    >
  >
...
export type LearningProfileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<LearningProfileFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LearningProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends LearningProfileCountArgs>(
    args?: Prisma.Subset<T, LearningProfileCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], LearningProfileCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, LearningProfileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLearningProfileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
