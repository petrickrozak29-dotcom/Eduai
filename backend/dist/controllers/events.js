...
export const getAll = async (req, res) => {
    try {
        ...
        sendError(res, "Gagal mengambil event", 500, error.message);
    }
};
export const getById = async (req, res) => {
    try {
        ...
        sendError(res, "Gagal mengambil detail event", 500, error.message);
    }
};
export const create = async (req, res) => {
    try {
        ...
        sendError(res, "Gagal membuat event", 500, error.message);
    }
};
export const update = async (req, res) => {
    try {
        ...
        sendError(res, "Gagal memperbarui event", 500, error.message);
    }
};
export const remove = async (req, res) => {
    try {
        ...
        sendError(res, "Gagal menghapus event", 500, error.message);
    }
};
